...
def extract_all_data(spark):
    ...
    online_orders = extract_sales_data(spark, "dbfs:/FileStore/etl_data/online_orders.csv")
    store_orders = extract_sales_data(spark, "dbfs:/FileStore/etl_data/store_orders.csv")
    mobile_orders = extract_sales_data(spark, "dbfs:/FileStore/etl_data/mobile_orders.csv")
